    ...
    <div className="fixed left-0 right-0 z-20 py-2 h-16 bg-gray-50 px-6 md:px-4">
      <header className="flex justify-between items-center gap-3 md:gap-6 h-full container mx-auto">
        ...
        <Link className="sm:hidden block" href={"/"}>
          <Logo type="icon" otherStyles="" />
        </Link>
        <SearchInput />
        {!isAuthenticated && (
          <div className="md:flex gap-3 w-fit h-full items-center hidden">
            <button
            ...
            <SpringModal isOpen={modalOpen == 0} setIsOpen={setModalOpen}>
              <div>
                <SignupForm setOpen={setModalOpen} />
              </div>
            </SpringModal>
            <SpringModal isOpen={modalOpen == 1} setIsOpen={setModalOpen}>
              <div>
                <SigninForm setOpen={setModalOpen} />
              </div>
            </SpringModal>
          </div>
        )}
        {isAuthenticated && (
          <div className="md:flex gap-2 w-fit h-full items-center hidden">
                      ...
                      <>
                        ...
                        <div className="border-t mt-4 pt-4">
                          ...
                          <button
                            ...
                            className="w-full bg-[#2c6e49] text-white py-2 rounded-lg mt-4 transition-colors"
                          >
                            Checkout
                          </button>
                        </div>
            ...
            <div className="relative" ref={tradeRef}>
              <button onClick={handleTradeClick} className="flex items-center">
                <Notify
                  ...
                  <div className="p-4">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button
                        ...
                        className="text-sm text-[#2c6e49] hover:text-[#235539]"
                      >
                        View All
                      </button>
                    </div>
...
export const NavbarMobile = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      iconActive: (
        <AiOutlineSwap className="w-full h-full" color={forestGreen} />
      ),
    },
    {
      title: "Mission",
        ...
        {isAuthenticated ? (
          ...
          <div onClick={() => setOpen(0)}>
            <Chip
              ...
              iconActive={
                <IoPerson className="w-full h-full" color={forestGreen} />
              }
            />
          </div>
        )}
